...
const Sports = () => {
    ...
    var bodyLotionProducts = store.filter(product => product.type.includes('spwhatsnew')); 

    var bodyScrubProducts = store.filter(produt => produt.type.includes("sphighCost"));

    var bodyWashProducts = store.filter(product => product.type.includes("splowtohigh"));
    ...
    return (
        <div className='u20MainParent fof '>
            ...
            <div className='u20HeadingHold gap-20 justify-center relative flex flex-col'>
                <p className='u20Heading'>Sports Drive Tyres </p>
                <p className='u20Desc'> "Unleash the Power of Performance with our Sports Tyres - Where Precision Meets the Road."</p>
            </div>
            ...
            <div className='u20BreadCrumbHold absolute text-sm'>
                <Breadcrumb spacing='8px' separator={<ChevronRightIcon />}>
                    ...
                    <BreadcrumbItem>
                        <Link to={`/Sports`} href='#'>Sports Drive</Link>
                    </BreadcrumbItem>
                </Breadcrumb>
            </div>
            ...
            {allShow && <div className="flex u20prodsHold flex-wrap relative top-96 justify-center text-center">
                {store.map((item) => {
                    ...
                    if (item.type.includes("spwhatsnew"," sphighCost", "splowtohigh")) {
                        return (
