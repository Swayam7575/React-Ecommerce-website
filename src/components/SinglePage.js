  ...
  return (
    <div className='singlePageMainParent relative top-36'>
      ...
      <div className='sideImageHold flex flex-col relative gap-12'>
        ...
        <img src='https://www.tyremarket.com/images/products//P_Zero_PZ4_90.webp' className='w-64 cursor-pointer rounded-lg object-cover' onMouseEnter={imgSrcTarget} onMouseLeave={defaultImageSrc} />
      </div>

      <div className='bottomImgHold flex flex-row relative gap-8'>
        <img src='https://www.mrftyres.com/images/tyres/patterns/perfinza-right_angle.png' className=' w-80 si cursor-pointer object-cover' onMouseEnter={imgSrcTarget} onMouseLeave={defaultImageSrc} />
        <img src='https://www.mrftyres.com/images/tyres/patterns/perfinza-left_angle.png' className=' w-80 si cursor-pointer object-cover' id='mobileDontSHow' onMouseEnter={imgSrcTarget} onMouseLeave={defaultImageSrc} />
      </div>
