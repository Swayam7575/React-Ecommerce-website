...
const Offroad = () => {
    ...
    var bodyLotionProducts = store.filter(product => product.type.includes('orwhatsnew')); 

    var bodyScrubProducts = store.filter(produt => produt.type.includes("orhighCost"));

    var bodyWashProducts = store.filter(product => product.type.includes("orlowtohigh"));
    ...
    return (
        <div className='u20MainParent fof '>
            ...
            <div className='u20HeadingHold gap-20 justify-center relative flex flex-col'>
                <p className='u20Heading'>Off Road Tyres </p>
                <p className='u20Desc'> "Conquer the Uncharted with Our Off-Road Tyres - Your Path to Adventure Begins Where the Road Ends."</p>
            </div>
            ...
            <div className='u20BreadCrumbHold absolute text-sm'>
                <Breadcrumb spacing='8px' separator={<ChevronRightIcon />}>
                    ...
                    <BreadcrumbItem>
                        <Link to={`/Offroad`} href='#'>Off Road</Link>
                    </BreadcrumbItem>
                </Breadcrumb>
            </div>
            ...
            {allShow && <div className="flex u20prodsHold flex-wrap relative top-96 justify-center text-center">
                {store.map((item) => {
                    ...
                    if (item.type.includes("orwhatsnew", "orhighCost", "orlowtohigh")) {
                        return (
