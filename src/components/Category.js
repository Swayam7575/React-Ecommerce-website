    ...
    return (
        <div className='giftSetMainParent'>
            ...
            <div className='flex flex-col gap-8 bestSellerPriceHolder'>
                ...
                <Link to={"/CrossDrive"} >
                    <p className="hover:underline"> Cross Drive </p>
                </Link>

                <Link to={"/SecuraDrive"} >
                    <p className="hover:underline"> Secura Drive</p>
                </Link>

                <Link to={"/Offroad"} >
                    <p className="hover:underline"> Off Road </p>
                </Link>

                <Link to={"/Sports"} >
                    <p className="hover:underline"> Sports Drive </p>
                </Link>
